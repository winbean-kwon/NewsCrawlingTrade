...
class Crawler: # class providing company name & news title
    ...
    def crawl_news(self): # function providing company name & news title
        ...
        search_box = driver.find_element(By.XPATH,
                                        '/html/body/div[3]/div/main/div[2]/article/div/div[2]/div[2]/aside/nsdq-right-rail-desktop/div/div[1]/div/div[1]/form/div/div[2]/input')
        search_box.send_keys('direct offer')
        search_box.send_keys(Keys.RETURN)
        driver.find_element(By.XPATH,
                            '/html/body/div[2]/div/main/div[2]/div[3]/div/section/div[2]/div[3]/div[3]/div[1]/span[2]/select').click()
        driver.find_element(By.XPATH,
                            '/html/body/div[2]/div/main/div[2]/div[3]/div/section/div[2]/div[3]/div[3]/div[1]/span[2]/select/option[2]').click()

        i=1

        while True:
            title_text = driver.find_element(By.XPATH,
                                            '/html/body/div[2]/div/main/div[2]/div[3]/div/section/div[2]/div[3]/div[3]/div[2]/a[1]/div/div[1]').text
            duplicate_check = []
            ...
            print(search_symbol.search.check)
